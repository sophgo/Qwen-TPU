...
lib = ctypes.cdll.LoadLibrary('./build/libqwenc.so')
...
class QwenChat:
    ...
    def __init__(self, devid=0, bmodel_path="/workspace/aa/qwen-7b_int4.bmodel", tokenizer_path="/workspace/aa/Qwen-TPU/webdemo/qwen.tiktoken"):
